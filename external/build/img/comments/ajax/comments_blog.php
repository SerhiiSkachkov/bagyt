    ...
    <div class="comments-filter none">
        <div class="list-view-sorting clearfix">
            ...
            <select id="commentSortField" class="form-control input-sm">
                <option value="0" <? if ($backorder == 0) : ?> selected="selected" <? endif; ?>><?=Yii::t('app','Старые')?></option>
                <option value="1" <? if ($backorder == 1) : ?> selected="selected" <? endif; ?>><?=Yii::t('app','Новые')?></option>
            </select>
        </div>
    </div>
                    ...
                    <div id="comment-111" class="comment">
                        ...
                        <div class="comments-info">
                            <header class="comment-meta comment-author vcard clearfix">
                                <h4 class="text-blue"><span class="comment-author-admin <?=$comment->isAuthorAdmin() ? 'commentAuthorAdmin' : '';?>"><span></span><span><?=$comment->getUserName();?></span></span> <span class="comment-date">- <?=$created_date->format('H:i')?>, <?=$created_date->format('d.m.Y') ?></span></h4>
                                <div class="reply port-post-social pull-right"> 
                                    <?php if (Yii::app()->user->checkAccess('CommentsAnswer') && CommentsSettings::canPublishComments($comment->alias->object_alias) && ((int)$comment->status_id !== Comments::COMMENT_STATUS_DELETED  && (int)$comment->status_id !== Comments::COMMENT_STATUS_DELETED_FOREVER)) : ?>
                                        <a style="" href="#" class="comment_answer-comment comment-reply-link" title="<?=Yii::t('app', 'Ответить')?>"><i class="fa fa-share" aria-hidden="true"></i></a>
                                    <?php endif; ?>
                                    <?php if((CommentsSettings::canEditComment($comment, Yii::app()->user->id, 'CommentsEdit') || CommentsSettings::isModerator()) && ((int)$comment->status_id !== Comments::COMMENT_STATUS_DELETED_FOREVER)) : ?>
                                        <a style="" href="#" class="comment_edit-comment comment-reply-link" title="<?=Yii::t('app', 'Редактировать')?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php endif; ?>
                                    <?php if(CommentsSettings::isModerator() && ((int)$comment->status_id === Comments::COMMENT_STATUS_NOT_ACTIVE || (int)$comment->status_id === Comments::COMMENT_STATUS_MODERATE)) : ?>
                                        <a style="" href="#" class="comment_show-comment comment-reply-link" title="<?=Yii::t('app', 'Показать')?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    <?php endif; ?>
                                    <?php if(CommentsSettings::isModerator() && ((int)$comment->status_id === Comments::COMMENT_STATUS_ACTIVE || (int)$comment->status_id === Comments::COMMENT_STATUS_MODERATE)) : ?>
                                        <a style="" href="#" class="comment_hide-comment comment-reply-link" title="<?=Yii::t('app', 'Скрыть')?>"><i class="fa fa-eye-slash" aria-hidden="true"></i></a>
                                    <?php endif; ?>
                                    <?php if(CommentsSettings::isModerator() && ((int)$comment->status_id !== Comments::COMMENT_STATUS_DELETED  && (int)$comment->status_id !== Comments::COMMENT_STATUS_DELETED_FOREVER)) : ?>
                                        <a style="" href="#" class="comment_delete-comment comment-reply-link" title="<?=Yii::t('app', 'Удалить')?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php endif; ?>
                                </div>
                            </header>
