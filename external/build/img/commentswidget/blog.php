...
<script type="text/template" id="answer_template">
    ...
    <? endif; ?>
    <? if ((Captcha::captchaConditions('textCAPTCHA', 'comments_news', (int)TRUE) && $object_alias == 'news') || (Captcha::captchaConditions('textCAPTCHA', 'comments_blog_posts', (int)TRUE) && $object_alias == 'blog_posts')): ?>
    ...
    (function () {
        var Comments = function (params) {
            this.settings = {
                ...
                captcha: '<?= ($captcha_settings ? $captcha_settings->alias : ''); ?>',
            ...
            this.answer = function (event) {
                ...
                $('.comments_comment-block').find('.answer-block-ckeditor .cancell').click();
                ...
                textBlock.find('.answer-block-ckeditor').addClass('answer-block').show();
                    ...
                    success: function (data) {
                        if (data.html) {
                            ...
                            <? if((Captcha::captchaConditions('reCAPTCHA', 'comments_news', (int)TRUE) && $object_alias == 'news') || (Captcha::captchaConditions('reCAPTCHA', 'comments_blog_posts', (int)TRUE) && $object_alias == 'blog_posts')): ?>
                            textBlock.find('.answer-block-ckeditor .form-group').after("<div class = 'comment_captcha form-group'></div>");
                ...
                textEditBlock = textBlock.find('.answer-block');
                textEditBlock.show();
                <? else : ?>
